<template>
  <div>
    <v-tabs dark color="cyan" slot="extension" slider-color="yellow">
      <v-tab class="cyan" v-for="(tab, index) in propertyLabelTabs" 
      :to="{name: 'propertyLabels', params: {labelName: tab.tabValue}}"  :id="index" dark>
        {{ $t(tab.tabTitleKey) }}
      </v-tab>
      <v-tabs-items>
      </v-tabs-items>
...
<script>
import PropertyStates from '../../../mgmt/components/property-labels/PropertyStates'
import PropertyTypes from '../../../mgmt/components/property-labels/PropertyTypes'
import PropertyFeatures from '../../../mgmt/components/property-labels/PropertyFeatures'
